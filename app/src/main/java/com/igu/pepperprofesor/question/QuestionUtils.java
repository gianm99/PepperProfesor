...
public class QuestionUtils {
    ...
    static {
        questions = new Question[]{
                ...
                new OptionQuestion(CASTELLANO, 51, "Cuál es la palabra intrusa en esta familia?",
                        Arrays.asList(new Option('a', "Arena"),
                                new Option('b', "Área"),
                                new Option('c', "Arenal"))),
                new OptionQuestion(CASTELLANO, 52, "En la oración, La vieja fábrica, qué función realiza la?",
                        Arrays.asList(new Option('a', "Determinante"),
                                new Option('b', "Núcleo"),
                                new Option('c', "Complemento"))),
                new OptionQuestion(CASTELLANO, 53, "Cuál es el pretérito imperfecto de subjuntivo del verbo decir?",
                        Arrays.asList(new Option('a', "Dijera o dijese."),
                                new Option('b', "Dije"),
                                new Option('c', "Dijere"))),
                new OptionQuestion(CASTELLANO, 54, "Cuándo llevan tilde las palabras agudas?",
                ...
                new OptionQuestion(CASTELLANO, 55, "Cuál de estas palabras lleva tilde?",
                ...
                new OptionQuestion(CASTELLANO, 60, "Qué palabra lleva hache?",
                        Arrays.asList(new Option('a', "Invierno"),
                                new Option('b', "Orario"))),
                new OptionQuestion(CASTELLANO, 61, "Por qué el enunciado, Rebajas de invierno, no es una oración?",
                ...
                new OptionQuestion(CASTELLANO, 62, "Cuál de estos grupos son sinónimos entre ellos?",
                        Arrays.asList(new Option('a', "Limpiar, lavar, asear."),
                                new Option('b', "Andar, caminar, contemplar."))),
                new Question(CASTELLANO, 63, "Cuál es el antónimo de coser?"),
                new OptionQuestion(CASTELLANO, 64, "Cuál empieza por Y?",
                        Arrays.asList(new Option('a', "Yugular."),
                                new Option('b', "Lluvia"))),
                new Question(CASTELLANO, 65, "Qué letra le falta a jerse...?"),
                new Question(CASTELLANO, 66, "Cuál es el prefijo de superdotado?"),
                new Question(CASTELLANO, 67, "Cuál es el prefijo de antigripal?"),
                new OptionQuestion(CASTELLANO, 68, "Completa la oración, Este utensilio sirve para, ... el pan.",
                        Arrays.asList(new Option('a', "Rallar con ll."),
                                new Option('b', "Rayar con y"))),
                new OptionQuestion(CASTELLANO, 69, "Cuál es la palabra correcta? Los jueces ... al acusado porque era inocente.",
                        Arrays.asList(new Option('a', "Absolvieron"),
                                new Option('b', "Absorbieron"))),
                new OptionQuestion(CASTELLANO, 70, "Cuál de estas afirmaciones es falsa?",
                ...
                new OptionQuestion(CASTELLANO, 71, "La palabra UNICEF es",
                        Arrays.asList(new Option('a', "Una abreviatura"),
                                new Option('b', "Siglas"))),
                new OptionQuestion(CASTELLANO, 72, "La palabra Dña es",
                        Arrays.asList(new Option('a', "Una abreviatura"),
                                new Option('b', "Siglas"))),
                new OptionQuestion(CASTELLANO, 73, "Cuál es la palabra castellana correspondiente al extranjerismo confort?",
                        Arrays.asList(new Option('a', "Comodidad"),
                                new Option('b', "Encanto"))),
                new OptionQuestion(CASTELLANO, 74, "Cuál es la palabra castellana correspondiente al extranjerismo grill?",
                        Arrays.asList(new Option('a', "Hamburguesa"),
                                new Option('b', "Parrilla"))),
                new OptionQuestion(CASTELLANO, 75, "Las preposiciones son",
                ...
                new OptionQuestion(CASTELLANO, 76, "Las conjunciones son",
                        Arrays.asList(new Option('a', "Enlaces que unen dos palabras o grupos de palabras que corresponden a ideas semejantes"),
                                new Option('b', "Enlaces que unen dos palabras de modo que la segunda complementa a la primera"))),
                new OptionQuestion(CASTELLANO, 77, "El eufemismo de muerte es",
                        Arrays.asList(new Option('a', "Sustracción"),
                                new Option('b', "Defunción"))),
                new OptionQuestion(CASTELLANO, 78, "Completa la palabra a...edrez.",
                        Arrays.asList(new Option('a', "J"),
                                new Option('b', "G"))),
                new OptionQuestion(CASTELLANO, 79, "Completa la palabra e...emplo",
                        Arrays.asList(new Option('a', "J"),
                                new Option('b', "G"))),
                new OptionQuestion(CASTELLANO, 80, "Completa la palabra ...eranio",
                        Arrays.asList(new Option('a', "J"),
                                new Option('b', "G"))),
                new OptionQuestion(CASTELLANO, 81, "Completa la palabra e...pléndido",
                        Arrays.asList(new Option('a', "X"),
                                new Option('b', "S"))),
                new OptionQuestion(CASTELLANO, 82, "Completa la palabra e...plícito",
                        Arrays.asList(new Option('a', "X"),
                                new Option('b', "S"))),
                new OptionQuestion(CASTELLANO, 83, "Completa la palabra e...quema",
                        Arrays.asList(new Option('a', "X"),
                                new Option('b', "S"))),
                new Question(CASTELLANO, 84, "Cuáles son las siglas del Documento Nacional de Identidad?"),
                new OptionQuestion(CASTELLANO, 85, "La oración, Martín es una joya, tiene",
                        Arrays.asList(new Option('a', "Sentido literal"),
                                new Option('b', "Sentido figurado"))),
                new OptionQuestion(CASTELLANO, 86, "La oración, Eva es una lapa, no te la quitas de encima, tiene",
                        Arrays.asList(new Option('a', "Sentido literal"),
                                new Option('b', "Sentido figurado"))),
                new OptionQuestion(CASTELLANO, 87, "La oración, Entro en el gallinero a recoger los huevos, tiene",
                        Arrays.asList(new Option('a', "Sentido literal"),
                                new Option('b', "Sentido figurado"))),
                new OptionQuestion(CASTELLANO, 88, "En, Alicia escribió un cuento precioso. Un cuento precioso es",
                        Arrays.asList(new Option('a', "Complemento indirecto CI"),
                                new Option('b', "Complemento directo CD"))),
                new OptionQuestion(CASTELLANO, 89, "En, Vino ayer su primo Juan. Ayer es",
                        Arrays.asList(new Option('a', "Complemento circunstancial de modo"),
                                new Option('b', "Complemento circunstancial de tiempo"))),
                new OptionQuestion(CASTELLANO, 90, "Algo que no es legal es",
