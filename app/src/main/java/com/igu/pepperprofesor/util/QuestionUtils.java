...
public class QuestionUtils {
    ...
    static {
        questions = Arrays.asList(
                ...
                new OptionQuestion(MATEMATICAS, 1, "Dime el valor de CMLXII.",
                        Arrays.asList(new Option('a', "926"),
                                new Option('b', "962"),
                                new Option('c', "1962"))),
                new OptionQuestion(MATEMATICAS, 2, "Dime el valor de MMDCCVI",
                        Arrays.asList(new Option('a', "2706"),
                                new Option('b', "2506"),
                                new Option('c', "2556"))),
                new OptionQuestion(MATEMATICAS, 3, "Dime el valor de CMXLII.",
                        Arrays.asList(new Option('a', "942"),
                                new Option('b', "922"),
                                new Option('c', "1952"))),
                new OptionQuestion(MATEMATICAS, 4, "Dime en números romanos 1987.",
                        Arrays.asList(new Option('a', "MMLXXXVII"),
                                new Option('b', "MCMLXXXVII"),
                                new Option('c', "MCMLXXVII"))),
                new OptionQuestion(MATEMATICAS, 5, "Dime en números romanos 1439.",
                        Arrays.asList(new Option('a', "CXXXIX"),
                                new Option('b', "MCDXXXIX"),
                                new Option('c', "CDXXXIX"))),
                new OptionQuestion(MATEMATICAS, 6, "Dime en números romanos 1814.",
                        Arrays.asList(new Option('a', "CXXXIX"),
